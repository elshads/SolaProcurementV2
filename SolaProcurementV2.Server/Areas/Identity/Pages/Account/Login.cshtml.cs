...
using SolaProcurementV2.Server.Identity;
...
namespace SolaProcurementV2.Server.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public async Task OnPostCreate()
        {
            ...
            var appUser = await appUserService.GetByUserNameAsync("admin@this.app");
            if (appUser == null || appUser.Id == 0)
            {
                var newUser = new AppUser();
                newUser.UserName = "admin@this.app";
                newUser.Email = "admin@this.app";
                newUser.FullName = "Administrator";
                ...
                {
                    var sqlResult = await appUserService.CreateAsync(newUser, 0);
                }
            }
        }
